        ...
        <div className="animate-fade-in">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { name: 'Express.js', level: 'Advanced', color: 'from-gray-600 to-gray-800' },
              { name: 'Git/GitHub', level: 'Advanced', color: 'from-orange-500 to-red-500' },
              { name: 'Vercel', level: 'Intermediate', color: 'from-black to-gray-800' }
            ].map((skill, index) => (
              <div
                key={skill.name}
                className={`card p-4 hover:scale-105 transition-all duration-300 animate-scale-in`}
      ...
      <section id="projects" className="mx-auto max-w-6xl px-4 py-16 md:py-20">
        <div className="animate-fade-in">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Coffee Socks Shop */}
            <a
              href="https://socks-two.vercel.app/"
              target="_blank"
              className="group card p-5 hover:scale-105 transition-all duration-300 animate-scale-in"
            ...
            {[
              {
                ...
                content: "Ahmed delivered exceptional work on our e-commerce platform. His attention to detail and technical expertise helped us achieve our goals ahead of schedule.",
                avatar: "SJ"
              },
              {
                name: "Michael Chen",
                role: "Tech Lead",
                content: "Working with Ahmed was a great experience. He has strong problem-solving skills and writes clean, maintainable code. Highly recommended!",
                avatar: "MC"
              },
              {
                name: "Emily Rodriguez",
                role: "Startup Founder",
                content: "Ahmed helped us build our MVP from scratch. His full-stack expertise and understanding of user experience were invaluable to our success.",
                avatar: "ER"
              }
            ].map((testimonial, index) => (
              <div
                key={testimonial.name}
                className="card p-6 hover:scale-105 transition-all duration-300 animate-scale-in"
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="animate-slide-in-right">
              ...
              <div className="space-y-4">
                <a
                  href="mailto:ahmed.amr61991@gmail.com"
                  className="flex items-center gap-6 p-4 card hover:scale-105 transition-all duration-300 group"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/ahmed-amr-341b8b290"
                  target="_blank"
                  className="flex items-center gap-6 p-4 card hover:scale-105 transition-all duration-300 group"
                >
                  <div className="w-12 h-12 rounded-lg flex items-center justify-center text-white text-4xl md:text-4xl group-hover:scale-110 transition-transform">
                ...
                <a
                  href="https://github.com/AhmedAmr9"
                  target="_blank"
                  className="flex items-center gap-6 p-4 card hover:scale-105 transition-all duration-300 group"
                >
