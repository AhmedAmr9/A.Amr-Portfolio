      ...
      <section id="projects" className="mx-auto max-w-6xl px-4 py-16 md:py-20">
        <div className="animate-fade-in">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Coffee Socks Shop */}
            <a href="https://socks-coffee.vercel.app/" target="_blank" className="group card p-5 hover:scale-105 transition-all duration-300 animate-scale-in" style={{ animationDelay: '200ms' }}>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="animate-slide-in-right">
              ...
              <div className="space-y-4">
                ...
                <a href="https://www.linkedin.com/in/ahmed-amr-dev" target="_blank" className="flex items-center gap-6 p-4 card hover:scale-105 transition-all duration-300 group">
