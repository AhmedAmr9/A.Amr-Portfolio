...
//             onChange={handleInputChange}
//             className={`input w-full resize-none ${errors.message ? 'border-red-500 focus:border-red-500' : ''}`}
...
//           </div>
//           <p className="text-green-200 text-sm mt-1">Thank you for reaching out. I'll get back to you soon!</p>
//         </div>
//       )}
...
//           </div>
//           <p className="text-red-200 text-sm mt-1">Please try again later or contact me directly via email.</p>
//         </div>
//       )}
//     </div>
//   );
